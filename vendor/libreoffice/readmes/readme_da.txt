...
Katalogerne RPMS (eller DEBS, henholdsvis) indeholder også en pakke kaldet libreoffice7.6-freedesktop-menus-7.6.0.1-1.noarch.rpm (eller libreoffice7.6-debian-menus_7.6.0.1-1_all.deb, henholdsvis, eller lignende). Der en pakke til alle Linux-distributioner, som understøtter Freedesktop.org,s specifikationer/anbefalinger (https://en.wikipedia.org/wiki/Freedesktop.org), og stilles til rådighed for installation til på andre Linux-distributioner, der ikke er dækket i de førnævnte instruktioner.
...
Vi håber, at du får stor fornøjelse med at bruge den nye LibreOffice 7.6, samt at du vil tilmelde dig projektet online.
