...
Ma tha thu a’ cur luach ’nan saothair agus ma tha thu airson dèanamh cinnteach gum bi LibreOffice ri fhaighinn san àm ri teachd, nach beachdaich thu air taic a chur ris a’ phròiseact - thoir sùil air https://www.documentfoundation.org/contribution/ airson barrachd fiosrachaidh. ’S urrainn dhan a h-uile duine rud beag a chur ris an t-saothair.
...
* Microsoft Windows 7 SP1, 8, 8.1 Update (S14) no 10
...
Nuair a neo-phacas tu tasg-lann a fhuair thu on lìon, chì thu gun deach an t-susbaint ann a dhì-dhùmhlachadh ann am fo-phasgan. Fosgail uinneag ann am manaidsear nam faidhlichean agus thoir leum dhan phasgan a tha a' tòiseachadh le "LibreOffice_", le àireamh an tionndaidh 'na dhèidh 's cuid a dh'fhiosrachadh mun ùrlar.
...
Stàlaichidh na h-àitheantan a leanas LibreOffice agus na pacaidean desktop integration ('s urrainn dhut lethbhreac a dhèanamh dhiubh 's an cur ann an sgrìn an tèirmineil seach an sgrìobhadh às ùr):
...
Tha pacaid air a bheil libreoffice7.6-freedesktop-menus-7.6.0.1-1.noarch.rpm (no libreoffice7.6-debian-menus_7.6.0.1-1_all.deb (no rudeigin mar sin) sa phasgan RPMS (no DEBS) cuideachd. ’S e pacaid a tha ann airson gach sgaoileadh de Linux a bheir taic ris na molaidhean aig Freedesktop.org (https://en.wikipedia.org/wiki/Freedesktop.org) agus ’s ann a chum stàlaidhean air sgaoilidhean eile de Linux nach deach a mhìneachadh gu h-àrd a tha e.
...
Thoir leum dhan phasgan a-nis a chaidh a chruthachadh nuair a dhì-dhùmhlaich thu e. Mar eisimpleir, airson na pacaid cànain Fraingis air siostam 32-bit stèidhichte air Debian/Ubuntu, bidh LibreOffice_ air a' phasgan, le fiosrachadh mun tionndadh agus Linux_x86_langpack-deb_fr.
...
Gheibh thu cuideachadh le iomadh rud ann an LibreOffice air prìomh-dhuilleag na taice. Faodaidh gu bheil freagairt ann dhut mu thràth - feuch fòram na coimhearsnachd aig https://www.documentfoundation.org/nabble/ no rùraich tasg-lannan na liosta puist “users@libreoffice.org” aig https://www.libreoffice.org/lists/users/. Air neo, ’s urrainn dhut ceist a chur oirnn aig users@libreoffice.org. Ma tha thu airson fo-sgrìobhadh dhan liosta (gus am faigh thu na freagairtean), cuir post-d bàn gu: users+subscribe@libreoffice.org.
...
Tha sinn an dòchas gun gabh thu tlachd 'nad obair le LibreOffice 7.6 agus gum faic sinn thu air loidhne.
