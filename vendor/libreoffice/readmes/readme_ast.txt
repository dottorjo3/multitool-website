...
El direutoriu de RPM (ou DEB, según correspuenda) tamién contién un paquete llamáu libreoffice7.6-freedesktop-menus-7.6.0.1-1.noarch.rpm (o libreoffice7.6-debian-menus_7.6.0.1-1_all.deb, respeutivamente, o asemeyao). Esti ye un paquete pa toles distribuciones de Linux qu'almiten les especificaciones/recomendaciones de Freedesktop.org (https://en.wikipedia.org/wiki/Freedesktop.org), y úfrese pa permitir la instalación n'otres distribuciones de Linux que nun tán cubiertes poles anteriores instrucciones .
...
Esperamos que te preste trabayar col nuevu LibreOffice 7.6 y que te xuntes con nós en llinia.
