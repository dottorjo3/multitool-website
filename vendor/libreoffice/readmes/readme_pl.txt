...
======================================================================
Plik ReadMe programu LibreOffice 7.6
======================================================================
...
Katalog RPM (lub odpowiednio DEB) zawiera również pakiet o nazwie libreoffice7.6-freedesktop-menus-7.6.0.1-1.noarch.rpm (lub libreoffice7.6-debian-menus_7.6.0.1-1_all.deb). Jest on przeznaczony dla wszystkich dystrybucji Linuksa które wspierają specyfikacje/rekomendacje Freedesktop.org (https://en.wikipedia.org/wiki/Freedesktop.org) i nie zostały ujęte w niniejszej instrukcji.
...
Mamy nadzieję, że jesteś zadowolonym użytkownikiem nowego LibreOffice 7.6 i przyłączysz się do nas w internecie.
