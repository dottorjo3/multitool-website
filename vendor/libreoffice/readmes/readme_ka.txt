...
შენიშვნა: გთხოვთ გაითვალისწინოთ რომ ადმინისტრატორის უფლებებია საჭირო ინსტალაციის პროცესისათვის.
...
----------------------------------------------------------------------
Gnome-ის პროგრამული გაშვებისას წარმოქმნილი პრობლემები
----------------------------------------------------------------------
...
----------------------------------------------------------------------
ALPS/Synaptics ნოუთბუქის თითსასრიალო ვინდოუსში
----------------------------------------------------------------------
...
იმისათვის რათა შესაძლებელი გახადოთ გადაწევა თაჩფედის საშუალებით, დაამატეთ მომდევნო სტრიქონები  "C:\Program Files\Synaptics\SynTP\SynTPEnh.ini" კონფიგურაციის ფაილს, და გადატვირთეთ თქვენი კომპიუტერი.
...
შენიშვნა: საკონფიგურაციო ფაილის ადგილმდებარეობა შეიძლება განსხვავდებოდეს სხვადასხვა ვერსიებზე.
...
OpenOffice.org კავშირი ძალიან დიდ დახმარებას მიიღებს თუ თქვენ აქტიურად ჩაერთვებით ამ მნიშვნელოვანი ღია კოდის პროეკტის განვითარებაში.
