...
La cartele RPMS (o DEBS, secont il câs) e conten ancje un pachet clamât libreoffice7.6-freedesktop-menus-7.6.0.1-1.noarch.rpm (o libreoffice7.6-debian-menus_7.6.0.1-1_all.deb, secont il câs, o similâr). Chest al è un pachet par dutis lis distribuzions Linux che a supuartin lis specifichis/racomandazions di Freedesktop.org (https://en.wikipedia.org/wiki/Freedesktop.org), e al ven furnît pes instalazions su altris distribuzions di Linux no tratadis intes istruzions menzonadis in precedence.
...
O sperin che tu gjoldedis a lavorâ cul gnûf LibreOffice 7.6 e che tu partecipedis ae nestre comunitât online.
