...
======================================================================
LibreOffice Viktigt-fil för 7.6
======================================================================
...
Mappen RPMS (eller DEBS) innehåller också ett paket som heter libreoffice7.6-freedesktop-menus-7.6.0.1-1.noarch.rpm (eller libreoffice7.6-debian-menus_7.6.0.1-1_all.deb, eller liknande). Detta är ett paket för alla Linuxdistributioner som stödjer specifikationerna/rekommendationerna från Freedesktop.org (https://en.wikipedia.org/wiki/Freedesktop.org), och är till för installation på Linuxdistributioner som inte inkluderats i de tidigare nämna instruktionerna.
...
Vi hoppas att du kommer att uppskatta det nya LibreOffice 7.6 och delta online.
