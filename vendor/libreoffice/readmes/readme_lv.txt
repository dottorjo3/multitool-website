...
RPMS (vai attiecīgi DEBS) mape satur arī pakotni ar nosaukumu libreoffice-freedesktop7.6-menus-7.6.0.1-1.noarch.rpm (vai attiecīgi libreoffice7.6-debian-menus_7.6.0.1-1_all.deb). Šī ir pakotne visām Linux distribūcijām, kas atbalsta Freedesktop.org specifikācijas/rekomendācijas (https://en.wikipedia.org/wiki/Freedesktop.org), un tā tiek nodrošināta Linux distribūcijām, kas nav apskatītas iepriekš minētajās instrukcijās.
...
Mēs ceram, ka jums patiks strādāt ar jauno LibreOffice 7.6 un jūs mums pievienosieties tiešsaistē.
