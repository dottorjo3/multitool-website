...
======================================================================
LibreOffice 7.6:n LueMinut-tiedosto
======================================================================
...
Kansio RPMS (tai DEBS) sisältää myös paketin nimeltä libreoffice7.6-freedesktop-menus-7.6.0.1-1.noarch.rpm (tai libreoffice7.6-debian-menus_7.6.0.1-1_all.deb, tai vastaavan). Tämä paketti soveltuu kaikille Linux-jakeluille, jotka tukevat Freedesktop.orgin määrityksiä (https://en.wikipedia.org/wiki/Freedesktop.org). Se on tarkoitettu sellaisia Linux-jakeluita varten, joille ei ollut ohjeita edellä.
...
Toivomme, että viihdyt uuden LibreOffice 7.6:n parissa ja liityt joukkoomme verkossa.
