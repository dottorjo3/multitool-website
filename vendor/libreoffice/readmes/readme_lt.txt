...
======================================================================
„LibreOffice 7.6“ informacija naudotojui
======================================================================
...
„Fedora“ pagrindu sukurtoms sistemoms: sudo dnf install *.rpm
...
Aplanke RPMS (arba DEBS) taip pat yra paketas „libreoffice7.6-freedesktop-menus-7.6.0.1-1.noarch.rpm“ (arba libreoffice7.6-debian-menus_7.6.0.1-1_all.deb, arba panašus). Jis skirtas visoms su „Freedesktop.org“ specifikacijomis ir (arba) rekomendacijomis (https://en.wikipedia.org/wiki/Freedesktop.org) suderinamoms „Linux“ atmainoms. Šį paketą ir reikėtų diegti visose anksčiau nepaminėtose „Linux“ atmainose.
...
„Fedora“ pagrindu sukurtoms sistemoms: su -c 'dnf install *.rpm'
...
Nesklandumus paleidžiant „LibreOffice“, programos strigtis ar vaizdo ekrane problemas dažnai sukelia vaizdo plokštės tvarkyklė. Jei susiduriate su panašiais nesklandumais, atnaujinkite vaizdo plokštės tvarkyklę arba naudokite su operacine sistema pateikiamą tvarkyklę.
...
Tikimės, kad patiks dirbti naujuoju „LibreOffice 7.6“ paketu ir prisijungsite prie mūsų bendruomenės internete.
