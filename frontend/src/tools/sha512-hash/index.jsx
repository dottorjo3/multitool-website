// 🔧 File: frontend/src/tools/sha512-hash/index.jsx
// 🔗 Farm Ready — UI hash SHA512
  ...
  return (
    <div className='space-y-2'>
      <p className='text-sm text-slate-600'>
        Algoritmo: {result.algorithm.toUpperCase()} • Lunghezza: {result.length}
      </p>
