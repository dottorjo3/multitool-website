// 🔧 File: frontend/src/tools/developer-html-minifier/index.jsx
// 🔗 NeoPanze — HTML Minifier
...
const definition = {
  ...
  fields: [
    ...
    },
    {
      ...
      label: 'Collassa spazi bianchi',
      defaultValue: 'true',
    },
  ],
  ResultView,
  ctaLabel: 'Minifica HTML',
};
