...
const LABELS = {
  summary: "Sintesi",
  prompt: "Value prop generata",
  sections: "Struttura messaggi",
  metadata: "Punti chiave",
  tips: "Suggerimenti"
};
...
const definition = {
  ...
  fields: [
  {
    ...
    placeholder: "Es. piattaforma di automazione vendite",
    required: true,
    requiredError: "Indica il prodotto",
    doc: "Prodotto o servizio da posizionare."
  },
  {
    type: "text",
    name: "audience",
    label: "Pubblico obiettivo",
    placeholder: "Es. team sales B2B, ecommerce manager",
    required: true,
    requiredError: "Specifica il pubblico obiettivo",
    doc: "Segmento principale di clientela."
  },
  {
    type: "textarea",
    name: "advantage",
    label: "Vantaggio distintivo",
    placeholder: "Descrivi il beneficio unico o il punto di forza",
    rows: 3,
    required: true,
    requiredError: "Descrivi il vantaggio chiave",
    doc: "Vantaggio competitivo o beneficio principale."
  },
  {
    type: "select",
    name: "tone",
    ...
    doc: "Tono generale della comunicazione."
  }
],
  ctaLabel: 'Genera value proposition',
  ResultView,
};
